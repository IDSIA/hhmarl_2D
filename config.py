...
class Config(object):
    ...
    def __init__(self, mode:int):
        ...
        parser.add_argument('--batch_size', type=int, default=2000 if mode==0 else 100, help='PPO train batch size')
        parser.add_argument('--mini_batch_size', type=int, default=50, help='PPO train mini batch size')
        #256
    ...
    def set_metrics(self):
        ...
        add_str = ''
        #add_str = '_FriPunish'
        self.args.log_name = f'Level{self.args.level}_{self.args.agent_mode}'+add_str if self.mode == 0 else f'Commander_{self.args.num_agents}_vs_{self.args.num_opps}'
